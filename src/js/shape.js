...
var animate = function () {
  ...
  var rotateContainers = function rotateContainers(deg) {
    rotationPos += deg;
    rotationNeg -= deg;
  ...
  var modifyStroke = function modifyStroke(offset) {
    dashOffset += offset;
  ...
  var changeBackground = function changeBackground(hue) {
    var newH;
    if (bgForward) {
      if (bgH + hue <= bgMaxH) {
        bgH += hue;
  ...
  var newFrame = function newFrame(data) {
...
var shape = function () {
  ...
  var square = function square(inner) {
...
var canvas = function () {
  ...
  var ctXCount, ctYCount, ctXOffset, ctYOffset;
  ...
  var drawContainersL1 = function drawContainersL1() {
